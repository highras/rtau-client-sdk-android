...
public class ProcessRawData extends BaseFragment implements View.OnClickListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            try {
                testimage = BitmapFactory.decodeStream(this.getResources().getAssets().open("rtauimg.jpg"));
                testimage1 = BitmapFactory.decodeStream(this.getResources().getAssets().open("rtauimg1.jpg"));
            } catch (IOException e) {
                e.printStackTrace();
            }
...
//                Bitmap bm = BitmapFactory.decodeByteArray(imageBytes, 0, imageBytes.length);
            ...
            if (timeseq % 60 == 0){
                ...
                rtauClient.sendImageData(streamid,newBitmap, System.currentTimeMillis() );
//                rtauClient.sendImageData(streamid,testimage, System.currentTimeMillis() );
            }
