...
/*    public static final String EXTENSION_NAME = "agora-simple-filter"; // Name of target link library used in CMakeLists.txt
    ...
    public static final String EXTENSION_AUDIO_FILTER_VOLUME = "RTVT"; // Audio filter name defined in ExtensionProvider.h
    public static final String EXTENSION_VIDEO_FILTER_WATERMARK = "Watermark"; // Video filter name defined in ExtensionProvider.h
    ...
    private Button stoptension;
    private Button endtrans;
    private Button initasr;
...
//                engine.setExtensionProperty(EXTENSION_VENDOR_NAME, EXTENSION_AUDIO_FILTER_VOLUME, "volume", ""+progress);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        initasr = view.findViewById(R.id.initasr);
        starttrans = view.findViewById(R.id.starttrans);
        stoptension = view.findViewById(R.id.stoptension);
        endtrans = view.findViewById(R.id.endtrans);
        ...
        stoptension.setOnClickListener(new View.OnClickListener() {
            @Override
...
/*        initasr.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                engine.setExtensionProperty(EXTENSION_VENDOR_NAME, EXTENSION_AUDIO_FILTER_VOLUME, "startTranslate", jsonObject.toString());
            }
        });*/
...
//                    Log.i("sdktest", "java token is " + ApiSecurityExample.genToken(80001000,"qwerty"));
                ...
                engine.setExtensionProperty(EXTENSION_VENDOR_NAME, EXTENSION_AUDIO_FILTER_VOLUME, "iLiveData_start", jsonObject.toString());
            }
        });

        endtrans.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                engine.setExtensionProperty(EXTENSION_VENDOR_NAME, EXTENSION_AUDIO_FILTER_VOLUME, "iLiveData_end", "{}");
            }
        });
    }
